...
function Registro() {
  ...
  // URL pública de backend alojado en Render
  const backendUrl = "https://ejercicioparaninoscompletos-1.onrender.com";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${backendUrl}/api/usuarios/registro`, formData);
